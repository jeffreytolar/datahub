...
Python class: `SchemaFieldKeyClass`
...
Python class: `SchemaFieldInfoClass`
...
Python class: `BusinessAttributesClass`
...
Python class: `SchemaFieldAliasesClass`
...
Python class: `SemanticFieldAnnotationClass`
...
| Field | Type | Required | Description | Annotations |
|-------|------|----------|-------------|-------------|
| type | SemanticFieldType | ✓ | The kind of this field. Must be set for every annotated field; determines how downstream tools in... |  |
| expression | MetricExpression | ✓ | The SQL expression that computes this field, in one or more dialects. |  |
| aggregationFunction | string |  | The aggregation function applied to this field when used as a measure (e.g. "SUM", "COUNT_DISTINC... |  |
| dimension | Dimension |  | Dimension-specific metadata. Populated when `type == DIMENSION`; ignored otherwise. |  |
...
- Asserts
   ...
   - Assertion via `assertionInfo.customAssertion.fields`
